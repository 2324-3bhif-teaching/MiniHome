...
* Änderungen oder Erweiterungen der Anforderungen seitens des Auftraggebers während des Projekts, die zusätzlichen Aufwand erfordern könnten. -> schwer wiegend -> viel Zeitverlust
